...
const mockAlumniData: { [key: string]: AlumniProfile } = {
  '1': { id: '1', name: 'Priya Sharma', email: 'priya.sharma@example.com', graduationYear: 2016, department: 'Electronics & Comm. Engg.', currentCompany: 'Innovate Corp', currentRole: 'Project Manager', location: 'Bengaluru, India', avatarUrl: 'https://picsum.photos/seed/priya/200/200', bio: 'Experienced Project Manager in the tech industry. Passionate about bringing innovative products to market. GCELT Batch of 2016.', skills: ['Project Management', 'Agile', 'Scrum', 'Product Development'], linkedin: 'https://linkedin.com/in/priyasharma' },
  '2': { id: '2', name: 'Rajesh Kumar', email: 'rajesh.kumar@example.com', graduationYear: 2014, department: 'Mechanical Engineering', currentCompany: 'Tech Solutions LLC', currentRole: 'Lead Mechanical Engineer', location: 'Mumbai, India', avatarUrl: 'https://picsum.photos/seed/rajeshk/200/200', bio: 'Dedicated mechanical engineer with expertise in CAD and product design. Always looking for new challenges. GCELT Class of 2014.', skills: ['CAD', 'SolidWorks', 'Product Design', 'Finite Element Analysis'], linkedin: 'https://linkedin.com/in/rajeshkumar' },
  '3': { id: '3', name: 'Ananya Singh', email: 'ananya.singh@example.com', graduationYear: 2018, department: 'Civil Engineering', currentCompany: 'Creative Minds Agency', currentRole: 'Structural Engineer', location: 'Delhi, India', avatarUrl: 'https://picsum.photos/seed/ananya/200/200', bio: 'Structural engineer focused on sustainable building practices. Proud GCELT alumna, Batch 2018.', skills: ['Structural Analysis', 'AutoCAD', 'Sustainable Design', 'STAAD Pro'], linkedin: 'https://linkedin.com/in/ananyasingh' },
  '4': { id: '4', name: 'Amit Patel', email: 'amit.patel@example.com', graduationYear: 2015, department: 'Electrical Engineering', currentCompany: 'Future Builders Co.', currentRole: 'Senior Electrical Designer', location: 'Chennai, India', avatarUrl: 'https://picsum.photos/seed/amit/200/200', bio: 'Specializing in power systems and renewable energy. GCELT 2015 graduate.', skills: ['Power Systems', 'Renewable Energy', 'Circuit Design', 'MATLAB'], linkedin: 'https://linkedin.com/in/amitpatel' },
  ...
  '6': { id: '6', name: 'Vikram Das', email: 'vikram.das@example.com', graduationYear: 2013, department: 'Leather Technology', currentCompany: 'Global Web Services', currentRole: 'Lead Technologist', location: 'Pune, India', avatarUrl: 'https://picsum.photos/seed/vikram/200/200', bio: 'Expert in leather processing and sustainable practices in the leather industry. GCELT 2013.', skills: ['Leather Finishing', 'Tannery Operations', 'Quality Control', 'Sustainable Leather'], linkedin: 'https://linkedin.com/in/vikramdas' },
  '7': { id: '7', name: 'Deepika Iyer', email: 'deepika.iyer@example.com', graduationYear: 2019, department: 'Computer Science & Engg.', currentCompany: 'Data Insights Inc.', currentRole: 'Data Scientist', location: 'Bengaluru, India', avatarUrl: 'https://picsum.photos/seed/deepika/200/200', bio: 'Passionate about leveraging data to solve real-world problems. GCELT CSE Batch of 2019.', skills: ['Machine Learning', 'Python', 'SQL', 'Data Visualization', 'Statistics'], linkedin: 'https://linkedin.com/in/deepikaiyer' },
  '8': { id: '8', name: 'Arjun Reddy', email: 'arjun.reddy@example.com', graduationYear: 2012, department: 'Electronics & Comm. Engg.', currentCompany: 'Telecom Giant Corp', currentRole: 'Network Architect', location: 'Noida, India', avatarUrl: 'https://picsum.photos/seed/arjunr/200/200', bio: 'Experienced Network Architect specializing in 5G technology. Always exploring new communication frontiers. GCELT ECE 2012.', skills: ['Network Design', '5G', 'TCP/IP', 'Cisco Networking', 'Security'], linkedin: 'https://linkedin.com/in/arjunreddy' },
  '9': { id: '9', name: 'Meera Menon', email: 'meera.menon@example.com', graduationYear: 2020, department: 'Information Technology', currentCompany: 'CyberSafe Solutions', currentRole: 'Cybersecurity Analyst', location: 'Kochi, India', avatarUrl: 'https://picsum.photos/seed/meera/200/200', bio: 'Dedicated to protecting digital assets and ensuring online safety. Recent GCELT IT graduate, Batch 2020.', skills: ['Ethical Hacking', 'SIEM', 'Incident Response', 'Vulnerability Assessment'], linkedin: 'https://linkedin.com/in/meeramenon' },
  '10': { id: '10', name: 'Rohan Gupta', email: 'rohan.gupta@example.com', graduationYear: 2011, department: 'Mechanical Engineering', currentCompany: 'AutoInnovate Ltd.', currentRole: 'Automotive Design Lead', location: 'Gurgaon, India', avatarUrl: 'https://picsum.photos/seed/rohan/200/200', bio: 'Leading innovation in automotive design with a focus on electric vehicles. GCELT Mechanical, Class of 2011.', skills: ['Automotive Design', 'CATIA', 'EV Technology', 'Prototyping'], linkedin: 'https://linkedin.com/in/rohan-gupta' },
};
